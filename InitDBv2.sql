...
INSERT INTO cathedras
    (id, name, phone_number)
VALUES
    ('id2', 'Multimedia', '322-534');
INSERT INTO cathedras
    (id, name, phone_number)
VALUES
    ('id3', 'Informatics', '322-535');
...
VALUES
    ('ids2', 'Odiseev', '322-538', 'man');
INSERT INTO scientists
    (scientist_id, second_name, phone_number, gender)
VALUES
    ('ids3', 'Mikituk', '32-538', 'man');
INSERT INTO scientists
    (scientist_id, second_name, phone_number, gender)
VALUES
    ('ids4', 'Denisenko', '324-538', 'man');
INSERT INTO scientists
    (scientist_id, second_name, phone_number, gender)
VALUES
    ('ids5', 'Simonenko', '325-538', 'man');
INSERT INTO scientists
    (scientist_id, second_name, phone_number, gender)
VALUES
    ('ids6', 'Medinsky', '326-538', 'man');
INSERT INTO scientists
    (scientist_id, second_name, phone_number, gender)
VALUES
    ('ids7', 'Losev', '327-538', 'woman');
INSERT INTO scientists
    (scientist_id, second_name, phone_number, gender)
VALUES
    ('ids8', 'Makeev', '328-538', 'woman');
INSERT INTO scientists
    (scientist_id, second_name, phone_number, gender)
VALUES
    ('ids9', 'Demin', '329-538', 'woman');
INSERT INTO scientists
    (scientist_id, second_name, phone_number, gender)
VALUES
    ('ids10', 'Mykioda', '3223-538', 'woman');
INSERT INTO scientists
    (scientist_id, second_name, phone_number, gender)
VALUES
    ('ids11', 'Voytasik', '3221-538', 'woman');
...
VALUES
    ('ids2', 'id1', 'Teacher', 'Doctor');
INSERT INTO teachers
VALUES
    ('ids3', 'id2', 'Chief', 'Candidate of science');
INSERT INTO teachers
VALUES
    ('ids4', 'id3', 'Teacher', 'Doctor');
...
VALUES
    ('ids5', 'id1', '2018-01-09', NULL, 'Mobile developing', '2020-01-07');
INSERT INTO postgraduates
VALUES
    ('ids6', 'id2', '2018-02-04', '2019-11-25', 'Problems of software engineering', '2019-07-21');
INSERT INTO postgraduates
VALUES
    ('ids7', 'id3', '2017-04-18', NULL, 'Neural networks', '2020-03-22');
...
INSERT INTO masters
VALUES
    ('ids8', 'id1', 'ids2', 'Front-end developing', '2017-07-24', '2021-07-24', 'Family troubles');
INSERT INTO masters
VALUES
    ('ids9', 'id2', 'ids3', 'Back-end developing', '2019-07-24', '2021-02-22', 'Army');
INSERT INTO masters
VALUES
    ('ids10', 'id3', 'ids4', 'Full-stack developing', '2018-07-24', '2021-03-26', NULL);


CREATE TABLE science_themes
(
    id VARCHAR(255) PRIMARY KEY,
    chief_id VARCHAR(255),
    cathedra_id VARCHAR(255) NOT NULL,
    name VARCHAR(255) NOT NULL,
...
VALUES
    ('idst1', 'ids2', 'id1', 'Ontological systems', 'IBM', '2018-11-04', '2021-03-27');
INSERT INTO science_themes
VALUES
    ('idst2', 'ids3', 'id2', 'Quantum systems', 'Microsoft', '2013-04-24', NULL);
INSERT INTO science_themes
VALUES
    ('idst3', 'ids4', 'id3', 'Linear math', 'Apple', '2018-01-04', NULL);
...
VALUES
    ('idsw1', 'Javascript Frameworks', 'Monography', 2020);
INSERT INTO scientific_works
VALUES
    ('idsw2', 'Java Frameworks', 'Article', 2020);
INSERT INTO scientific_works
VALUES
    ('idsw3', 'C++ Frameworks', 'Book', 2008);
